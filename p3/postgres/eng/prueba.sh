#!/bin/bash
# Script: docker_postgres_videojuegos_en.sh
# Objetivo: Crear las tablas para el sistema de videojuegos en inglés en el esquema 'esquema_videojuegos_en'
...
# Crear las tablas en el esquema 'esquema_videojuegos_en'
...
"
echo "Tablas creadas correctamente en el esquema 'esquema_videojuegos_en'."
echo "Fin del script."