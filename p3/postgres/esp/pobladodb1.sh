#!/bin/bash
# Script: docker_postgres_videojuegos_poblar_db1.sh
# Objetivo: Poblar las tablas del esquema 'esquema_videojuegos' en la base de datos 'db1'
...
echo "Ejecutando script dentro del contenedor '$CONTAINER_NAME' para poblar las tablas en español en 'db1'..."
...
echo "Tablas pobladas correctamente en 'db1'."
