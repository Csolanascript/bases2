...
echo "Eliminando todas las tablas y el esquema 'esquema_videojuegos'..."
...
DROP SCHEMA IF EXISTS esquema_videojuegos CASCADE;
"

echo "Esquema 'esquema_videojuegos' eliminado correctamente (junto con todas sus tablas)."
