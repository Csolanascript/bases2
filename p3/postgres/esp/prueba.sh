#!/bin/bash
# Script: docker_postgres_videojuegos_es.sh
# Objetivo: Crear las tablas para el sistema de videojuegos en español en el esquema 'esquema_videojuegos'
...
echo "Ejecutando script dentro del contenedor '$CONTAINER_NAME' para crear las tablas en español..."
...
# Crear las tablas en el esquema 'esquema_videojuegos'
...
"
echo "Tablas creadas correctamente en el esquema 'esquema_videojuegos'."
echo "Fin del script."